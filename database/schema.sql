...
-- INSERT INTO stories (brief, brand) VALUES
-- ('A revolutionary AI-powered task management tool that helps developers organize their workflow and boost productivity.',
--  '{"name": "TaskMaster AI", "tone": "professional", "palette": ["#3b82f6", "#1e40af", "#64748b"], "logoAlt": "TaskMaster AI logo"}');
